...
use bevy_mod_billboard::texture::BillboardMaterialExtension;
...
fn setup_billboard(
    ...
    let material_handle = asset_server.add(ExtendedMaterial::<
        StandardMaterial,
        BillboardMaterialExtension,
    > {
        base: image_handle.clone().into(),
